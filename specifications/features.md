...
get(targetIds: \[(PushDeviceType, String)\], state?: .Active \| .Failed) -\> io PaginatedResult`<PushDeviceRegistration>`{=html}\
...
get(type: PushDeviceType, targetId: String, channelName: String?) =\> io PaginatedResult`<PushChannelSubscription>`{=html}\
