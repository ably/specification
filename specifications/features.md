...
- `(RSL12)` `RestChannel#updateMessage` function:
  ...
  - `(RSL12d)` The function signals success or failure according to the http response per our normal REST standards. It does not return a value on success
- `(RSL13)` `RestChannel#deleteMessage` function:
  ...
  - `(RSL13d)` The function signals success or failure according to the http response per our normal REST standards. It does not return a value on success
