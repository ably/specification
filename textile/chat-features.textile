...
h2(#version). Chat Specification Version
...
h2(#major-revision-history). Major Revision History
...
h3(#chat-structs-presence-event). Presence Event (deprecated)
...
h3(#chat-structs-presence-event-v2). Presence Event V2
...
h3(#chat-structs-typing-event-V2). Typing Event V2 @(deprecated)@
...
h3(#chat-structs-typing-event-V3). Typing Event V3
...
h3(#chat-structs-occupancy-event). Occupancy Event (Deprecated)
...
h3(#chat-structs-occupancy-event-v2). Occupancy Event V2
...
h3(#chat-structs-occupancy-data). Occupancy Data
