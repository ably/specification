...
*** @(CHA-M4k4)@ @[Testable]@ This specification point has been removed. It was valid up until the Protocol V4 Changes.
*** @(CHA-M4k5)@ @[Testable]@ The @version@ field object shall have each of its fields set as follows:
**** @(CHA-M4k5a)@ @[Testable]@ The @serial@ field containing shall be set to empty string.
**** @(CHA-M4k5b)@ @[Testable]@ The @timestamp@ field shall be 0 (the unix epoch).
**** @(CHA-M4k5c)@ @[Testable]@ The @clientId@, @description@ and @metadata@ fields shall all be undefined.
...
h4(#rest-sending-messages-reactions-request-v4). Request V3
...
h4(#rest-deleting-messages-reactions-request-v4). Request V3
...
h4(#chat-structs-message-v2). Messages V2 @(deprecated)@
...
h4(#chat-structs-message-v4). Messages V4
