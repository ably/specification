...
** @(TM2f)@ This clause has been deleted. It was valid up to and including specification version 3.0 and has been superseded by @TM2t@.
** @(TM2t)@ @timestamp@ time in milliseconds since epoch. Represents the time that the message was originally created on the server (as encoded in the @TM2r@ serial). If a message received from Ably over a realtime transport does not contain a @timestamp@, the SDK must set it to the @timestamp@ of the encapsulating @ProtocolMessage@
** @(TM2j)@ @action@ enum
** @(TM2p)@ This clause has been deleted. It was valid up to and including specification version 3.0 and has been superseded by @TM2s@
** @(TM2s)@ @version@ - an object containing information about the latest version of a message. It may not be populated - see individual items for population schemes.
*** @(TM2s1)@ @serial@ - an opaque string that identifies the specific version of the message. If a message received from Ably (whether over realtime or REST, eg history) with an @action@ of @MESSAGE_CREATE@ does not contain a @version@, the SDK must set it equal to the @TM2r@ @serial@.
*** @(TM2s2)@ @timestamp@ - time in milliseconds since epoch. If a message received from Ably (whether over realtime or REST, eg history) with an @action@ of @MESSAGE_CREATE@ does not contain a @version@, the SDK must set it equal to the @TM2t@ @timestamp@.
*** @(TM2s3)@ @clientId@ - string
*** @(TM2s4)@ @description@ - string
*** @(TM2s5)@ @metadata@ - object - used to contain any arbitrary key value pairs of type string.
** @(TM2k)@ This clause has been deleted. It was valid up to and including specification version 3.0 and has been superseded by @TM2r@.
** @(TM2r)@ @serial@ string - an opaque string that uniquely identifies the message.
** @(TM2o)@ This clause has been deleted. It was valid up to and including specification version 3.0 and its purpose moved to @TM2t@.
** @(TM2n)@ This clause has been deleted. It was valid up to and including specification version 3.0 and has been melded into @TM2s@.
*** @(TM2n1)@ This clause has been deleted. It was valid up to and including specification version 3.0 and has been moved to @TM2s3@.
*** @(TM2n2)@ This clause has been deleted. It was valid up to and including specification version 3.0 and has been moved to @TM2s4@.
*** @(TM2n3)@ This clause has been deleted. It was valid up to and including specification version 3.0 and has been moved to @TM2s5@.
...
** @(TM2u)@ @annotations@ - an object containing information about the annotations associated with the message. It may not be populated - see individual items for population schemes.
*** @(TM2u1)@ @summary@ - a @TM2a@ summary object. If @TM2u@ is not populated, the @summary@ should be an empty object per @TM2q@
