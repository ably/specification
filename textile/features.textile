...
* @(RTL26)@ @RealtimeChannel#objects@ attribute:
** @(RTL26a)@ Returns the @Objects@ object for this channel
...
Reserved for @Objects@ feature specification, see "objects-features":../objects-features.
