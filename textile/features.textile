...
** @(OOP4h)@ The size of the map create component is: if @mapCreate@ is present, its size calculated per "MCR3":#MCR3; else if @mapCreateWithObjectId@ is present, the size of the @MapCreate@ retained in "RTO11f18":objects-features#RTO11f18, calculated per "MCR3":#MCR3; otherwise zero
...
** @(OOP4k)@ The size of the counter create component is: if @counterCreate@ is present, its size calculated per "CCR3":#CCR3; else if @counterCreateWithObjectId@ is present, the size of the @CounterCreate@ retained in "RTO12f16":objects-features#RTO12f16, calculated per "CCR3":#CCR3; otherwise zero
