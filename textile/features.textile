...
** @(RSL12b)@ The SDK must send a POST to @/channels/{channelName}/messages/{serial}@, with any @params@ sent in the querystring. The request body must consists of an object with the following fields:
...
** @(RSL13b)@ The SDK must send a POST to @/channels/{channelName}/messages/{serial}/delete@, with any @params@ sent in the querystring. The request body must consists of an object with the following fields:
