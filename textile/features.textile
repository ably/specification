...
* @(SM1)@ A @StateMessage@ represents an individual object message to be sent or received via the Ably Realtime service
* @(SM2)@ The attributes available in a @StateMessage@ are:
** @(SM2a)@ @id@ string - unique ID for this object message. This attribute is always populated for object messages received over REST. For object messages received over Realtime, if the object message does not contain an @id@, it should be set to @protocolMsgId:index@, where @protocolMsgId@ is the id of the @ProtocolMessage@ encapsulating it, and @index@ is the index of the object message inside the @state@ array of the @ProtocolMessage@
** @(SM2b)@ @clientId@ string
** @(SM2c)@ @connectionId@ string. If an object message received from Ably does not contain a @connectionId@, it should be set to the @connectionId@ of the encapsulating @ProtocolMessage@
...
** @(SM2e)@ @timestamp@ time in milliseconds since epoch. If an object message received from Ably does not contain a @timestamp@, it should be set to the @timestamp@ of the encapsulating @ProtocolMessage@
** @(SM2f)@ @operation@ @StateOperation@ object. Mutually exclusive with the @object@ field. This field is only set on object messages if the @action@ field of the @ProtocolMessage@ encapsulating it is @STATE@
** @(SM2g)@ @object@ @StateObject@ object. Mutually exclusive with the @operation@ field. This field is only set on object messages if the @action@ field of the @ProtocolMessage@ encapsulating it is @STATE_SYNC@
** @(SM2h)@ @serial@ string - an opaque string that uniquely identifies this object message
** @(SM2i)@ @siteCode@ string - an opaque string used as a key to update the map of @serial@ values on an object
...
** @(SOP3g)@ @nonce@ string - the nonce, must be present on @COUNTER_CREATE@ and @MAP_CREATE@ operations sent to the server
...
** @(SOB2b)@ @siteTimeserials@ @Dict<String, String>@ - a map of "serials":#SM2h keyed by "siteCode":#SM2i, representing the last operations applied to this object
...
** @(ME2b)@ @timeserial@ string - the @serial@#SM2h value of the last operation that was applied to the map entry
...
** @(SD2c)@ @value@ string, number, boolean or binary - a concrete value of the object
...
** @(CP2b)@ @channelSerial@ string - contains the last @channelSerial@ received in any @MESSAGE@, @PRESENCE@, @STATE@, or @ATTACHED@ @ProtocolMessage@ on the channel, see "RTL15b":#RTL15b
...
enum StateOperationAction: // SOP2, internal
  MAP_CREATE // SOP2
  MAP_SET // SOP2
  MAP_REMOVE // SOP2
  COUNTER_CREATE // SOP2
...
class StateMessage // SM*, internal
  id: String // SM2a
...
class StateOperation // SOP*, internal
...
class StateObject // SOB*, internal
