...
h3(#rest-annotations). RestAnnotations
...
** @(OOP3c)@ @mapCreate@ @MapCreate@ object - the payload for a @MAP_CREATE@ operation received from the server, containing the initial value for the Map object
** @(OOP3d)@ @mapSet@ @MapSet@ object - the payload for a @MAP_SET@ operation
** @(OOP3e)@ @mapRemove@ @MapRemove@ object - the payload for a @MAP_REMOVE@ operation
** @(OOP3f)@ @counterCreate@ @CounterCreate@ object - the payload for a @COUNTER_CREATE@ operation received from the server, containing the initial value for the Counter object
** @(OOP3g)@ @counterInc@ @CounterInc@ object - the payload for a @COUNTER_INC@ operation
** @(OOP3h)@ @objectDelete@ @ObjectDelete@ object - the payload for an @OBJECT_DELETE@ operation
** @(OOP3i)@ @mapCreateWithObjectId@ @MapCreateWithObjectId@ object - the payload for a @MAP_CREATE@ operation sent by the client to the server
** @(OOP3j)@ @counterCreateWithObjectId@ @CounterCreateWithObjectId@ object - the payload for a @COUNTER_CREATE@ operation sent by the client to the server
...
** @(OOP4b)@ The size of the @mapCreate@ property is calculated per "MCR3":#MCR3
** @(OOP4c)@ The size of the @mapSet@ property is calculated per "MST3":#MST3
** @(OOP4d)@ The size of the @mapRemove@ property is calculated per "MRM3":#MRM3
** @(OOP4e)@ The size of the @counterCreate@ property is calculated per "CCR3":#CCR3
** @(OOP4f)@ The size of the @counterInc@ property is calculated per "CIN3":#CIN3
** @(OOP4g)@ The size of a @null@ or omitted property is zero
* @(OOP5)@ @ObjectOperation@ encoding:
** @(OOP5a)@ @ObjectData@ values within @mapCreate.entries@, @mapSet.value@, and @ObjectState.createOp@ fields must be encoded per "OD4":#OD4
...
** @(MCR3a)@ The size is the sum of the sizes of all map entries in @entries@
...
* @(ODE1)@ An @ObjectDelete@ describes the payload for an @OBJECT_DELETE@ operation. This type has no attributes

h4. MapCreateWithObjectId

* @(MCW1)@ A @MapCreateWithObjectId@ describes the payload for a @MAP_CREATE@ operation sent by the client to the server
* @(MCW2)@ The attributes available in a @MapCreateWithObjectId@ are:
** @(MCW2a)@ @initialValue@ string - a JSON string representation of the encoded @MapCreate@ that contains the initial value for the map, created per "RTO13":#RTO13
** @(MCW2b)@ @nonce@ string - the nonce used to generate the object ID

h4. CounterCreateWithObjectId

* @(CCW1)@ A @CounterCreateWithObjectId@ describes the payload for a @COUNTER_CREATE@ operation sent by the client to the server
* @(CCW2)@ The attributes available in a @CounterCreateWithObjectId@ are:
** @(CCW2a)@ @initialValue@ string - a JSON string representation of the encoded @CounterCreate@ that contains the initial value for the counter, created per "RTO13":#RTO13
** @(CCW2b)@ @nonce@ string - the nonce used to generate the object ID
...
class ObjectOperation // OOP*, internal
  ...
  mapCreate: MapCreate? // OOP3c
  mapSet: MapSet? // OOP3d
  mapRemove: MapRemove? // OOP3e
  counterCreate: CounterCreate? // OOP3f
  counterInc: CounterInc? // OOP3g
  objectDelete: ObjectDelete? // OOP3h
  mapCreateWithObjectId: MapCreateWithObjectId? // OOP3i
  counterCreateWithObjectId: CounterCreateWithObjectId? // OOP3j
...
class MapCreateWithObjectId // MCW*, internal
  initialValue: String // MCW2a
  nonce: String // MCW2b

class CounterCreateWithObjectId // CCW*, internal
  initialValue: String // CCW2a
  nonce: String // CCW2b
