...
** @(RTL15b)@ @channelSerial@ is updated whenever a @ProtocolMessage@ with either @MESSAGE@, @PRESENCE@, @STATE@, or @ATTACHED@ actions is received on a channel, and is set to the @TR4c@ @channelSerial@ of that @ProtocolMessage@, if and only if that field (@ProtocolMessage.channelSerial@) is populated.
...
* @(SM1)@ A @StateMessage@ represents an individual objects message to be sent or received via the Ably Realtime service
* @(SM2)@ The attributes available in a @StateMessage@ are:
** @(SM2a)@ @id@ string - unique ID for this objects message. This attribute is always populated for objects messages received over REST. For objects messages received over Realtime, if the objects message does not contain an @id@, it should be set to @protocolMsgId:index@, where @protocolMsgId@ is the id of the @ProtocolMessage@ encapsulating it, and @index@ is the index of the objects message inside the @state@ array of the @ProtocolMessage@
** @(SM2b)@ @clientId@ string
** @(SM2c)@ @connectionId@ string. If an objects message received from Ably does not contain a @connectionId@, it should be set to the @connectionId@ of the encapsulating @ProtocolMessage@
** @(SM2d)@ @extras@ JSON-encodable object, used to contain any arbitrary key value pairs which may also contain other primitive JSON types, JSON-encodable objects or JSON-encodable arrays. The @extras@ field is provided to contain message metadata and/or ancillary payloads in support of specific functionality. For 3.1 no specific functionality is specified for @extras@ in objects messages. Unless otherwise specified, the client library should not attempt to do any filtering or validation of the @extras@ field itself, but should treat it opaquely, encoding it and passing it to realtime unaltered
** @(SM2e)@ @timestamp@ time in milliseconds since epoch. If an objects message received from Ably does not contain a @timestamp@, it should be set to the @timestamp@ of the encapsulating @ProtocolMessage@
** @(SM2f)@ @operation@ @StateOperation@ object
** @(SM2g)@ @object@ @StateObject@ object
** @(SM2h)@ @serial@ string - the origin timeserial of this objects message
** @(SM2i)@ @siteCode@ string - the site code corresponding to this objects message's timeserial in the @serial@ property
* @(SM3)@ The size of the @StateMessage@ for "TO3l8":#TO3l8 is calculated as follows:
** @(SM3a)@ The size is the sum of the sizes of the @clientId@, @operation@, @object@, and @extras@ properties
** @(SM3b)@ The size of the @operation@ property is calculated per "SOP4":#SOP4
** @(SM3c)@ The size of the @object@ property is calculated per "SOB3":#SOB3
** @(SM3d)@ The size of the @extras@ property is the string length of its JSON representation
** @(SM3e)@ The size of a @null@ or omitted property is zero

h4. StateOperation

* @(SOP1)@ A @StateOperation@ describes an operation to be applied to an object on a channel
* @(SOP2)@ @StateOperation@ @Action@ enum has the following values in order from zero: @MAP_CREATE@, @MAP_SET@, @MAP_REMOVE@, @COUNTER_CREATE@, @COUNTER_INC@, @OBJECT_DELETE@
* @(SOP3)@ The attributes available in a @StateOperation@ are:
** @(SOP3a)@ @action@ enum - defines the operation to be applied to the object
** @(SOP3b)@ @objectId@ string - the object ID of the object on a channel to which the operation should be applied
** @(SOP3c)@ @mapOp@ @MapOp@ object - the payload for the operation if it is an operation on a @Map@ object type
** @(SOP3d)@ @counterOp@ @CounterOp@ object - the payload for the operation if it is an operation on a @Counter@ object type
** @(SOP3e)@ @map@ @Map@ object - the payload for the operation if the operation is @MAP_CREATE@. Defines the initial value for the @Map@ object
** @(SOP3f)@ @counter@ @Counter@ object - the payload for the operation if the operation is @COUNTER_CREATE@. Defines the initial value for the @Counter@ object
** @(SOP3g)@ @nonce@ string - the nonce, must be present on objects create operations sent to the server
** @(SOP3h)@ @initialValue@ binary - the initial value bytes for the object
** @(SOP3i)@ @initialValueEncoding@ string - defines how the @initialValue@ should be interpreted. Should be @msgpack@ or @json@
* @(SOP4)@ The size of the @StateOperation@ is calculated as follows:
** @(SOP4a)@ The size is the sum of the sizes of the @mapOp@, @counterOp@, @map@, and @counter@ properties
** @(SOP4b)@ The size of the @mapOp@ property is calculated per "MOP3":#MOP3
** @(SOP4c)@ The size of the @counterOp@ property is calculated per "COP3":#COP3
** @(SOP4d)@ The size of the @map@ property is calculated per "MAP4":#MAP4
** @(SOP4e)@ The size of the @counter@ property is calculated per "CNT3":#CNT3
** @(SOP4f)@ The size of a @null@ or omitted property is zero

h4. StateObject

* @(SOB1)@ A @StateObject@ describes the instantaneous state of an object on a channel
* @(SOB2)@ The attributes available in a @StateObject@ are:
** @(SOB2a)@ @objectId@ string - the identifier of the object
** @(SOB2b)@ @siteTimeserials@ @Dict<String, String>@ - a vector of origin timeserials keyed by site code of the last operation that was applied to this object
** @(SOB2c)@ @tombstone@ boolean - true if the object has been tombstoned
** @(SOB2d)@ @createOp@ @StateOperation@ object - the operation that created the object
** @(SOB2e)@ @map@ @Map@ object - the data that represents the state of the object if it is a @Map@ object type
** @(SOB2f)@ @counter@ @Counter@ object - the data that represents the state of the object if it is a @Counter@ object type
* @(SOB3)@ The size of the @StateObject@ is calculated as follows:
** @(SOB3a)@ The size is the sum of the sizes of the @map@, @counter@, and @createOp@ properties
** @(SOB3b)@ The size of the @map@ property is calculated per "MAP4":#MAP4
** @(SOB3c)@ The size of the @counter@ property is calculated per "CNT3":#CNT3
** @(SOB3d)@ The size of the @createOp@ property is calculated per "SOP4":#SOP4
** @(SOB3e)@ The size of a @null@ or omitted property is zero
...
** @(MOP2b)@ @data@ @StateData@ object - the data that the map entry should contain if the operation is a @MAP_SET@ operation
* @(MOP3)@ The size of the @MapOp@ is calculated as follows:
** @(MOP3a)@ The size is the sum of the sizes of the @key@ and @data@ properties
** @(MOP3b)@ The size of the @data@ property is calculated per "SD3":#SD3
...
** @(ME2b)@ @timeserial@ string - the origin timeserial of the last operation that was applied to the map entry
** @(ME2c)@ @data@ @StateData@ object - the data that represents the value of the map entry.
* @(ME3)@ The size of the @MapEntry@ is calculated as follows:
** @(ME3a)@ It is equal to the size of the @data@ property
** @(ME3b)@ The size of the @data@ property is calculated per "SD3":#SD3
** @(ME3c)@ The size of a @null@ or omitted property is zero

h4. StateData

* @(SD1)@ A @StateData@ represents a value in an object on a channel
* @(SD2)@ The attributes available in a @StateData@ are:
** @(SD2a)@ @objectId@ string - a reference to another object
** @(SD2b)@ @encoding@ string - the encoding the client library should use to interpret the @value@
** @(SD2c)@ @value@ string, number, boolean or buffer - a concrete value of the object
* @(SD3)@ The size of the @StateData@ is calculated as follows:
** @(SD3a)@ It is equal to the size of the @value@ property
** @(SD3b)@ The size of a @binary@ @value@ property is its size in bytes (of the actual binary, not the base64 representation, regardless of whether the binary protocol is in use)
** @(SD3c)@ The size of a @number@ @value@ property is 8
** @(SD3d)@ The size of a @boolean@ @value@ property is 1
** @(SD3e)@ The size of a @null@ or omitted property is zero
...
* @(TR2)@ @ProtocolMessage@ @Action@ enum has the following values in order from zero: @HEARTBEAT@, @ACK@, @NACK@, @CONNECT@, @CONNECTED@, @DISCONNECT@, @DISCONNECTED@, @CLOSE@, @CLOSED@, @ERROR@, @ATTACH@, @ATTACHED@, @DETACH@, @DETACHED@, @PRESENCE@, @MESSAGE@, @SYNC@, @AUTH@, @ACTIVATE@, @STATE@, @STATE_SYNC@
...
** @(TR4r)@ @state@ Array of @StateMessage@ objects
...
** @(CP2b)@ @channelSerial@ string - contains the last @channelSerial@ received in any @MESSAGE@, @PRESENCE@, @STATE@, or @ATTACHED@ @ProtocolMesage@ on the channel, see "RTL15b":#RTL15b
...
h4. TokenRevocationTargetSpecifier
...
h4. TokenRevocationSuccessResult
...
h4. TokenRevocationFailureResult
...
** @(TO3g)@ @queueMessages@ boolean - defaults to true. If false, suppresses the default queueing of @MESSAGE@, @PRESENCE@ or @STATE@ protocol messages. See "RTL6c":#RTL6c for connection and channel state condition details
...
**** @(TO3l8f)@ The size is defined as the sum of all message sizes being published, calculated based on "TM6":#TM6, "TP5":#TP5 and "SM3":#SM3
...
enum StateOperationAction: // SOP2
  MAP_CREATE // SOP2
  MAP_SET // SOP2
  MAP_REMOVE // SOP2
  COUNTER_CREATE // SOP2
...
class StateMessage // SM*
  id: String // SM2a
  clientId: String // SM2b
  connectionId: String // SM2c
  extras: JsonObject? // SM2d
  timestamp: Time // SM2e
  operation: StateOperation? // SM2f
  object: StateObject? // SM2g
  serial: String // SM2h
  siteCode: String // SM2i

class StateOperation // SOP*
  action: StateOperationAction // SOP3a
  objectId: String // SOP3b
  mapOp: MapOp? // SOP3c
  counterOp: CounterOp? // SOP3d
  map: Map? // SOP3e
  counter: Counter? // SOP3f
  nonce: String? // SOP3g
  initialValue: Binary? // SOP3h
  initialValueEncoding: String? // SOP3i

class StateObject // SOB*
  objectId: String // SOB2a
  siteTimeserials: Dict<String, String> // SOB2b
  tombstone: Boolean // SOB2c
  createOp: StateOperation? // SOB2d
  map: Map? // SOB2e
  counter: Counter? // SOB2f

class MapOp // MOP*
  key: String // MOP2a
  data: StateData? // MOP2b
...
class StateData // SD*
  objectId: String? // SD2a
  encoding: String? // SD2b
  value: (String | Number | Boolean | Binary)? // SD2c
