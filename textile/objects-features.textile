...
* @(RTLM23)@ The initial value from @ObjectOperation.mapCreate@ can be merged into this @LiveMap@ in the following way:
** @(RTLM23a)@ For each key-@ObjectsMapEntry@ pair in @ObjectOperation.mapCreate.entries@:
...
h3(#livecountervaluetype). LiveCounterValueType
...
h3(#livemapvaluetype). LiveMapValueType
