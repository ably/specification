...
- list<PublishResult> @res@ := Present in @ACK@ Protocol Messages. Contains one @PublishResult@ per acknowledged @ProtocolMessage@ in order. Each @PublishResult@ contains a @serials@ array with the message serials corresponding 1:1 to the messages that were published. A serial may be null if the message was discarded due to a configured conflation rule.
...
- list<string> @serials@ := An array of message serials corresponding 1:1 to the messages that were published in the acknowledged @ProtocolMessage@. A serial may be null if the message was discarded due to a configured conflation rule.
