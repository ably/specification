...
| connectivityCheckUrl: String default "https://internet-up.ably-realtime.com/is-the-internet-up.txt" ||| REC3 | The URL of an endpoint that the SDK can use to determine whether the Internet connection is working. |
