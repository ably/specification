...
|------|-----------|-------------|
| AO2 | key | API key for authentication |
| AO2 | token | Token string for authentication |
| AO2 | tokenDetails | TokenDetails object for authentication |
| AO2 | authCallback | Callback function for token generation |
| AO2 | authUrl | URL for token requests |
| AO2 | authMethod | HTTP method for authUrl requests |
| AO2 | authHeaders | Headers for authUrl requests |
| AO2 | authParams | Parameters for authUrl requests |
| AO2 | queryTime | Whether to query server time |
