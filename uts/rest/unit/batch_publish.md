...
**Spec requirement:** When idempotent REST publishing is enabled, batch publish must generate unique message IDs following the RSL1k1 format (baseId:serial).
...
When batchPublish is called with multiple BatchPublishSpecs:
  - Spec1: 2 messages
  - Spec2: 3 messages
Then the captured request shows Spec1 messages have ids: "base1:0", "base1:1"
